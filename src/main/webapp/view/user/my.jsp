...
<!-- Mirrored from gambolthemes.net/workwise-new/my-profile-feed.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 22 Sep 2019 14:22:15 GMT -->
<head>
    <meta charset="UTF-8">
    ...
    <header>
        <div class="container">
            <div class="header-data">
                <div class="logo">
                    <a href="../../index.html" title=""><img src="images/${user.userId}.jpg" alt="userPic"></a>
                </div><!--logo end-->
                            ...
                            <div class="main-left-sidebar">
                                <div class="user_profile">
                                    ...
                                    <ul class="social_links">
                                        ...
                                        <li><i class="la la-globe"></i> Lives at <b>Texas</b></li>
                                        <li><i class="la la-globe"></i> Gender <b>Male</b></li>
                                        <li><i class="la la-globe"></i> Email <b>ali@mum.edu</b></li>
                                            ...
                                            <div class="posts-bar">
                                                <div class="post-bar bgclr">
                                                    <div class="wordpressdevlp">
                                                        ...
                                                        <div class="row no-gutters">
                                                            <div class="col-md-6 col-sm-12">
                                                                <p class="posttext"><i class="la la-clock-o"></i>Posted
                                                                    on 5 June 2018</p>
                                                            </div>
                                                            <div class="col-md-6 col-sm-12">
                                                                <p><i class="la la-clock-o"></i>Expiried on 5 October
                                                                    2018</p>
                                                            </div>
                                                        </div>
                                                    </div>
